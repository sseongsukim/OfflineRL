...
def evaluate_with_trajectories(
        ...
        use_waypoints=False, eval_temperature=0, epsilon=0, goal_info=None, planning_fn= None,
    ...
    for i in range(num_episodes + num_video_episodes):
        ...
        while not done:
            ...
            # a, prev_mean = planning_fn(observations= observation, goals= cur_obs_goal_rep, pm = prev_mean, temperature= 1.0)
